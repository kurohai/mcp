...
@ns.doc(responses={404: 'Outlet not found'})
@ns.route('/')
class ListAllDevices(Resource):
    @ns.doc(description='List of all outlets')
    def get(self):
...
@ns.doc(responses={404: 'Outlet not found'}, params={'outlet_name': 'The outlet name'})
...
class OutletEndpoint(Resource):
    ...
    def get(self, outlet_name):
        ...
        if o:
            ...
            return 404
    # @ns.doc(parser=outletparser, description='Add new outlet')
    # @ns.doc(description='Add new outlet')
...
# @ns.doc(responses={404: 'Outlet not found'}, params={'outlet_name': 'The outlet name', 'action': 'on or off'})
...
class OutletControl(Resource):
    ...
    @ns.doc(description='Control outlets')
